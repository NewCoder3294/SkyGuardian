      ...
      <section className="bg-surface">
        <header className="flex items-baseline justify-between border-b border-border px-4 py-2">
          ...
          <div className="flex items-baseline gap-4">
            {activeThreats > 0 && (
              <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-fail">
        ...
        {board.length === 0 ? (
          <div className="px-4 py-8 text-center font-mono text-[10px] uppercase tracking-widest text-text-dim">
